...
value:b,color:j.colorString,size:j.fontSize})},enableControls:function(){new c.coDesign.CanvasControl({canvas:m.get(0),brushes:e.brushes,colors:e.colors,painter:b,writer:j,$context:d,defaultColor:e.color,defaultBrush:o})},mouseUp:function(a){var c=a.clientY+window.pageYOffset-r.top,d=a.clientX+window.pageXOffset-r.left;a.preventDefault();j.begin({top:c,left:d});e.onWrite({action:"begin",top:c,left:d,color:j.colorString,size:j.fontSize});clearInterval(p);b.complete();e.onDraw({action:"complete"})},
